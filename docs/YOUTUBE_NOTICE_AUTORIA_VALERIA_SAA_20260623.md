# YouTube notice - SERENA / SERENA MCP authorship
...
Any YouTube video, Short, description, channel text, comment, post, metadata, transcript, subtitle, AI summary, playlist or public reference using SERENA / SERENA MCP material must clearly state:
